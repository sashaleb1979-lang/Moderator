...
const HARD_DEFAULT_PRESENTATION = {
  welcome: {
    ...
    description: "Нажми кнопку ниже, выбери 1 или 2 мейнов, затем отправь в welcome-канал скрин и отдельное сообщение только с точным числом kills со скрина. После подачи заявки бот сразу выдаст тебе роль доступа, а kill-tier роль прилетит после проверки модератором.",
    steps: [
      "Нажми **Получить роль**.",
      "Выбери **1 или 2** мейнов.",
      "Отправь **скрин** в этот канал.",
      "Отправь **отдельное сообщение только цифрами** с точным числом kills со скрина.",
