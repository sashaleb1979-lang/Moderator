...
- channels.tierlistChannelId — канал, где бот держит постоянное сообщение текстового тир-листа
...
- отправит или обновит постоянный текстовый тир-лист в отдельном tierlist-канале
- будет ждать нажатия на кнопки welcome-flow и текстового тир-листа
...
- /onboard panel — переотправить welcome-панель
...
7. Проверь, что в tierlist-канале бот создал постоянное сообщение с тир-листом.
