    ...
    .addComponents(
      new ActionRowBuilder().addComponents(
        new TextInputBuilder()
          ...
          .setLabel("Canonical Character ID")
          .setStyle(TextInputStyle.Short)
          .setRequired(true)
          .setMaxLength(80)
          .setPlaceholder("honored_one")
      ),
      new ActionRowBuilder().addComponents(
        new TextInputBuilder()
    ...
    .addComponents(
      new ActionRowBuilder().addComponents(
        new TextInputBuilder()
          ...
          .setRequired(true)
          .setMaxLength(40)
          .setPlaceholder("moderator / accessNormal / accessCompanion / killTier:1 / killMilestone:20k / legacyEloTier:1")
      ),
      new ActionRowBuilder().addComponents(
        new TextInputBuilder()
