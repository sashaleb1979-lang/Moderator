...
const COMBINED_SUBMISSION_WELCOME_DESCRIPTION = "Нажми кнопку ниже, выбери 1 или 2 мейнов, затем укажи точное количество kills и отправь скрин, чтобы получить роль доступа. Kill-tier роль прилетит после проверки модератором.";
const COMBINED_SUBMISSION_WELCOME_STEPS = [
  "Нажми **Получить роль**.",
  "Выбери **1 или 2** мейнов в панели выбора.",
  "Нажми **Указать kills** и сохрани точное число, либо сразу отправь его в тексте вместе со скрином.",
  "После этого отправь скрин в этот канал. Если kills уже указал в панели, число можно не дублировать в сообщении.",
